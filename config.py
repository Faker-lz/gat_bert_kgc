...
def get_args():
    ...
    parser.add_argument('--all_file_path', type=str, required=True, help="Path to the file containing all data")
    parser.add_argument('--train_file_path', type=str, required=True, help="Path to the training data file")
    parser.add_argument('--valid_file_path', type=str, required=True, help="Path to the validation data file")
